...
public class SendEmailUtil {
    public static String username = "1061349616@qq.com";//发送者
    private static String password = "lwcxhklslyfpbbed";//授权码
...
//        props.setProperty("spring.mail.properties.mail.starttls.required","true");
    ...
    public static void main(String[] args) {
        ...
        sendCode("1061349616@qq.com",code);
    }
