...
@WebServlet("/trade/pay")
public class TradePayController extends HttpServlet {
    @Override
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Pay pay = new Pay();
        pay.setOrderId(Long.parseLong(out_trade_no));
        pay.setUserId(Integer.parseInt(userId));
        pay.setAmount(Double.parseDouble(total_amount));
        pay.setPayMethod(1);
        pay.setPayStatus(10);
